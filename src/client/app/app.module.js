...
var AppModule = (function () {
    ...
    AppModule = __decorate([
        core_1.NgModule({
            ...
            declarations: [app_component_1.AppComponent, title_component_1.TitleComponent, highlight_directive_1.HighlightDirective, job_component_1.JobComponent],
            bootstrap: [app_component_1.AppComponent],
            providers: [job_restclient_1.JobRESTClient]
        }), 
